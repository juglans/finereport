...
<Query>
<![CDATA[select * from (SELECT a.客户名称,a.金额 FROM 应收应付 as a where a.类型标注=${leixing} and a.账龄类型 = '${aaa}'  order by a.金额 desc  limit 5) d
]]></Query>
</TableData>
...
<Query>
<![CDATA[SELECT 类型标注,sum(金额)/1000000 as 总金额 FROM 应收应付 where 类型标注=${leixing} group by 类型标注]]></Query>
</TableData>
...
<TextAttr>
<Attr alignText="0">
<FRFont name="Verdana" style="0" size="128" foreground="-10066330"/>
</Attr>
</TextAttr>
<AttrToolTipContent>
<Attr isCommon="true"/>
...
<AxisRange minValue="=0" maxValue="=0"/>
...
<BoundsAttr x="0" y="0" width="480" height="252"/>
</Widget>
...
<BoundsAttr x="0" y="35" width="480" height="252"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<DataProcessor class="com.fr.base.chart.chartdata.model.NormalDataModel"/>
<ChartDefinition>
<OneValueCDDefinition seriesName="地区" valueName="金额" function="com.fr.data.util.function.SumFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[ds1]]></Name>
...
<BoundsAttr x="480" y="0" width="480" height="252"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart1"/>
<WidgetAttr>
...
<BoundsAttr x="480" y="35" width="480" height="252"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="0" y="0" width="480" height="253"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart2"/>
<WidgetAttr>
...
<BoundsAttr x="0" y="287" width="480" height="253"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<AxisLabelCount value="=0"/>
<AxisRange/>
<AxisUnit201106 isCustomMainUnit="false" isCustomSecUnit="false" mainUnit="=50000" secUnit="=0"/>
<ZoomAxisAttr isZoom="false"/>
<axisReversed axisReversed="false"/>
...
<BoundsAttr x="480" y="0" width="480" height="253"/>
</Widget>
<body class="com.fr.form.ui.ChartEditor">
<WidgetName name="chart3"/>
<WidgetAttr>
...
<BoundsAttr x="480" y="287" width="480" height="253"/>
</Widget>
<Sorted sorted="false"/>
