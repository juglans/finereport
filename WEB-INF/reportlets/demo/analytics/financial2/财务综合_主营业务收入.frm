...
<![CDATA[]]></DSName>
<ColumnNames>
<![CDATA[日期,,.,,主营业务收入,,.,,净利润,,.,,应收账款]]></ColumnNames>
<ColumnTypes>
<![CDATA[java.lang.String,java.lang.String,java.lang.String,java.lang.String]]></ColumnTypes>
<RowData>
<![CDATA[7F"I7^`X%QdC"=f8i@68qd6FbK%*4)4GBse?;?;%qBdE]AaL%UP)NC,dBL=q^RsNI:Kul.:UB
h<I"b./L:T(I"e=`3KSsB-I;V694EfMFT-fkKN0'U`_0Qn->Qf=>!<nuG",_#~
]]></RowData>
</TableData>
</TableDataMap>
...
<ChartSummaryColumn name="主营业务收入" function="com.fr.data.util.function.NoneFunction" customName="主营业务收入"/>
<ChartSummaryColumn name="净利润" function="com.fr.data.util.function.NoneFunction" customName="净利润"/>
...
<BoundsAttr x="0" y="36" width="960" height="457"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<Attributes>
<![CDATA[="  "+"近12个月趋势分析（单位：万元）"]]></Attributes>
</O>
</widgetValue>
...
<ChartSummaryColumn name="环比" function="com.fr.data.util.function.NoneFunction" customName="环比"/>
<ChartSummaryColumn name="同期" function="com.fr.data.util.function.NoneFunction" customName="同期"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="false" export="false" fullScreen="false"/>
...
<BoundsAttr x="0" y="47" width="960" height="493"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="0" y="0" width="960" height="47"/>
</Widget>
<Sorted sorted="false"/>
